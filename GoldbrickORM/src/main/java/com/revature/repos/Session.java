...
public class Session {
	...
	public List<Class<?>> selectAll(Connection conn, Class<?> clazz){
		try {
	...
	public List<Order> selectAll(Metamodel<Order> mm, Connection conn){
		try {
			return GetDB.getAllOrders(conn, mm);
		} catch (SQLException e) {
			log.warn(e.getMessage());
			e.printStackTrace();
			return null;
